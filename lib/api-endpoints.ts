...
export const API_ENDPOINTS: Record<string, ApiEndpointConfig> = {
    ...
    CUSTOMERS_LOGIN_REQUEST: {
        path: '/customers/login/request',
        method: 'POST',
        auth: false,
        description: 'Request OTP for customer login'
    },
    CUSTOMERS_LOGIN_VERIFY: {
        path: '/customers/login/verify',
        method: 'POST',
        auth: false,
        description: 'Verify OTP and complete customer login'
    },
    CUSTOMERS_DELETE_REQUEST: {
        path: '/customers/delete/request',
        method: 'POST',
        auth: true,
        description: 'Request OTP for customer account deletion'
    },
    CUSTOMERS_DELETE_COMPLETE: {
        path: '/customers/delete/complete',
        method: 'POST',
        auth: true,
        description: 'Verify OTP and complete customer account deletion'
    },
    ...
    FOODS_ALL: {
        ...
        method: 'GET',
        auth: true,
        description: 'List all available foods from all restaurants'
    },
    FOODS_RESTAURANT_MENU: {
        path: '/foods/restaurant/:restaurantId/menu',
        method: 'GET',
        auth: true,
