    ...
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div className="flex-1">
          <h1 className="text-2xl font-semibold tracking-tight text-balance">All Foods</h1>
          <p className="text-sm text-muted-foreground">Browse available foods from all restaurants</p>
        </div>
